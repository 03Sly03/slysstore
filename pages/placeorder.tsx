...
function PlaceOrderScreen() {
  ...
  const placeOrderHandler = async () => {
    try {
      ...
      setLoading(false);
      dispatch!({ type: 'CART_CLEAR_ITEMS', payload: {} });
      Cookies.set(
        'cart',
        JSON.stringify({
          ...cart,
        ...
        <div className="grid md:grid-cols-4 md:gap-5">
          <div className="overflow-x-auto md:col-span-3">
            <div className="card p-5">
              <h2 className="mb-2 text-lg font-bold">Adresse de livraison</h2>
              <div className="mb-2">
            ...
            <div className="card p-5">
              <h2 className="mb-2 text-lg font-bold">Méthode de paiement</h2>
            ...
            <div className="card overflow-x-auto p-5">
              <h2 className="mb-2 text-lg font-bold">Articles commandés</h2>
